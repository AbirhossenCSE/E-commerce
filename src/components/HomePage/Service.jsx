...
const Service = () => {
    return (
        <div className="w-full flex flex-wrap justify-center gap-6 p-6 bg-gray-100">
            {services.map((service, index) => (
                <div
                    key={index}
                    className="bg-white rounded-lg shadow-md p-3 flex items-center gap-4 w-full sm:w-auto md:w-5/12 lg:w-1/4 xl:w-1/5"
                >
                    <div className="bg-black rounded-full p-3 flex items-center justify-center">
                        {service.icon}
                    </div>
